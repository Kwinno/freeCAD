...
<body>
    ...
    if (isset($_GET['error']) && strip_tags($_GET['error']) === 'no-updates') {
        throwError('We didn\'t detect that you changed anything.');
                            ...
                            <div class="profile-info-detail">
                                <form method="POST">
                                    ...
                                    <div class="form-group text-center">
                                        <div class="col-12">
                                            <button class="btn btn-success btn-bordred btn-block waves-effect waves-light" type="submit" name="updateSettingsBtn">Update Settings</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
