                          ...
                          <div class="row">
                            <div class="col-12">
                              ...
                              <form method="POST">
                                ...
                                <div class="form-group text-center">
                                  <div class="col-12">
                                    <button class="btn btn-danger btn-bordred waves-effect waves-light float-right" type="submit" name="banUserBtn" onclick="return confirm('Are you sure you want to ban <?php echo $editingUser['username']; ?>?')">Ban <?php echo $editingUser['username']; ?></button>
                                  </div>
                                </div>
                              </form>
                            </div>
