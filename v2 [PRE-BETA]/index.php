    ...
    <div class="wrapper m-b-15">
        <div class="container-fluid">
            ...
            <div class="alert alert-warning" role="alert">
                <?php echo $doul; ?><strong>Warning: </strong> This is a PRE-BETA release. We do not support public use of this version, as modules are missing and bugs may be present. Report any bugs on our Discord.
            </div>
            <div class="row">
