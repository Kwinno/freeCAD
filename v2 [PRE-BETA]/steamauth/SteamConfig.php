...
$steamauth['apikey'] = $settings['steam_domain']; // Your Steam WebAPI-Key found at https://steamcommunity.com/dev/apikey
$steamauth['domainname'] = $settings['steam_api']; // The main URL of your website displayed in the login page
