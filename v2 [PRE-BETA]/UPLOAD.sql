...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 15, 2019 at 01:12 AM
...
INSERT INTO `settings` (`setting_id`, `site_name`, `account_validation`, `identity_validation`, `steam_required`, `steam_domain`, `steam_api`, `discord_alerts`, `discord_webhook`, `timezone`, `civ_side_warrants`, `add_warrant`, `group_unverifiedGroup`, `group_verifiedGroup`, `group_banGroup`) VALUES
(1, 'CAD/MDT', 'no', 'no', 'false', NULL, NULL, 'false', NULL, 'America/New_York', 'true', 'all', 2, 3, 1);
