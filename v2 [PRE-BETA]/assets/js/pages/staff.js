function setIdentityVerification(str) {
 if (str == "") {
     ...
     xmlhttp.send();
     toastr.success('Identity Verification Settings Updated.', 'System:', {timeOut: 10000})
 }
}
...
function setAccountVerification(str) {
 if (str == "") {
     ...
     xmlhttp.send();
     toastr.success('Account Verification Settings Updated.', 'System:', {timeOut: 10000})
 }
}

function setDarkTheme(str) {
 if (str == "") {
     return;
 } else {
     if (window.XMLHttpRequest) {
     ...
     xmlhttp.open("GET", "inc/backend/staff/settings/setDarkTheme.php?q=" + str, true);
     xmlhttp.send();
     toastr.success('Theme Settings Updated... The page will reload for changes to take effect!', 'System:', {timeOut: 10000})
     location.reload();
 }
}
...
function setCivSideWarrants(str) {
 if (str == "") {
     ...
     xmlhttp.send();
     toastr.success('Settings Updated.', 'System:', {timeOut: 10000})
 }
}
