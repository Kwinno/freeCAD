  ...
  <th><center></center></th>
    ...
    case 'getPendingIds':
        ...
        if ($_GET['decline']) {
            ...
            $stmt2->execute();
            $new_status = "Yes";
            $sql3       = "UPDATE `identities` SET `is_leo`=:new_status WHERE identity_id=:identity_id";
            $stmt3      = $pdo->prepare($sql3);
            $stmt3->bindParam(':new_status', $new_status);
            $stmt3->bindParam(':identity_id', $identity_id);
            $stmt3->execute();
